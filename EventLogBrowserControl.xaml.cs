...
{
    /// <summary>
    /// Interaction logic for EventLogBrowserControl.
    /// </summary>
    public partial class EventLogBrowserControl : UserControl
    {
        private EventLogService eventLogService;
        private ObservableCollection<EventLogs> eventLogs;

        /// <summary>
        /// Initializes a new instance of the <see cref="EventLogBrowserControl"/> class.
        /// </summary>
        public EventLogBrowserControl()
        {
